...
<div class="home-carousel" data-carousel>
  ...
  <div class="home-carousel__controls">
    <button class="home-carousel__button" type="button" data-carousel-prev aria-label="Previous image">&#8592;</button>
    <span class="home-carousel__status"><span data-carousel-current>1</span> / <span data-carousel-total>3</span></span>
    <button class="home-carousel__button" type="button" data-carousel-next aria-label="Next image">&#8594;</button>
  </div>
</div>
